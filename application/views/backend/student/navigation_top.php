				...
				<ul class="user-info pull-left pull-none-xsm">
					...
					<li class="profile-info dropdown"><!-- add class "pull-right" if you want to place this from right -->
						...
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							<img src="<?php echo $this->crud_model->get_image_url('admin',1);?>" class="img-circle" width="44"/>
				...
				<ul class="list-inline links-list pull-right">
					...
					<li class="dropdown language-selector">
						...
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-close-others="true">
							<img src="assets/images/flag/english.png" width="16" height="16" />
						</a>
		
						<ul class="dropdown-menu pull-right">
							<li>
								<a href="#">
									<img src="assets/images/flag/german.png" width="16" height="16" />
									<span>Deutsch</span>
								</a>
							</li>
							<li class="active">
							...
							<li>
								<a href="#">
									<img src="assets/images/flag/french.png" width="16" height="16" />
									<span>François</span>
								</a>
							</li>
							<li>
								<a href="#">
									<img src="assets/images/flag/flag-al.png" width="16" height="16" />
									<span>Shqip</span>
								</a>
							</li>
							<li>
								<a href="#">
									<img src="assets/images/flag/spanish.png" width="16" height="16" />
									<span>Español</span>
								</a>
							</li>
						</ul>
