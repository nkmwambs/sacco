...
<table class="table table-bordered datatable table-hover" id="table_export">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
            	<?php if(count($this->sacco_model->loans('active',$row['student_id']))>0){ ?>
            		<button class="btn btn-primary btn-icon" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_loan_details/<?php echo $row['student_id'];?>');"><i class="entypo-vcard"></i>Loans</button>
            	<?php }?>
            	<button class="btn btn-primary btn-icon"  onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_share_details/<?php echo $row['student_id'];?>');"><i class="entypo-share"></i>Shares</button>
           		<button class="btn btn-primary btn-icon" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_view_member/<?php echo $row['student_id'];?>');"><i class="fa fa-info-circle"></i>View Details</button>
            
            <!-- OPTION Tab-->
            
             <div class="btn-group">
                    <button type="button" class="btn btn-primary btn-sm dropdown-toggle" data-toggle="dropdown">
                        Action Group <span class="caret"></span>
                    </button>
